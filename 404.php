...
<main>
    <div class="container errorPage">
        <div class="row errorWrapper">
            <div class="col-md-6 align-self-center">
                <svg class="errorSvg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                     viewBox="0 0 800 600">
                    <g>
                        <defs>
            ...
            <div class="col-md-6 align-self-center">
                <h1>404</h1>
                <h2>О, нет! Ты потерялся?</h2>
                <p>Страница,которую искал - не существует!
                </p>
                <a href="<?php echo get_home_url(); ?>" class="goHome green">На Главную</a>
            </div>
        </div>
    </div>
</main>
